...
import { MdOutlineCopyright, MdOutlineEmail } from "react-icons/md";
            ...
            <footer className="footer max-w-7xl mb-0 mx-auto px-3 lg:px-0 text-base-content  py-28">
                ...
                <nav className="text-lg text-gray-300">
                    ...
                    <div className="grid grid-flow-col gap-4">
                        ...
                        <a className="text-blue-600" href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                        ...
                        <a className="text-red-600" href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                ...
                <p className=" text-center border-t border-gray-900 py-4">
