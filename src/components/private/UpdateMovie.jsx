...
const UpdateMovie = ({ onAddMovie }) => {
    ...
    const onSubmit = (data) => {
        ...
        // console.log("Movie update Data:", movieData);
            ...
            <div className='border border-gray-800 max-w-3xl mx-auto  p-8  '>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-control mt-6">
                        <button className="btn  bg-black border-red-700 text-white hover:bg-red-700 hover:text-black">Update Movie</button>
                    </div>
                </form>
            </div>
            <ToastContainer />
