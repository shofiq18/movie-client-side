    ...
    return (
      ...
      <figure>
        <img
          src={movie.poster}
          alt="poster"
          className="w-full h-[320px] transition-opacity duration-300 group-hover:opacity-20 rounded-none"
        />
      </figure>
      <div className="card-body p-4 bg-black rounded-none">
        ...
        <div className="flex justify-between">
          ...
          <p className="text-sm text-red-800 absolute bottom-20">{movie.duration} min</p>
        </div>
        ...
        <div className="card-actions opacity-0 group-hover:opacity-100 transition-opacity duration-300 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <Link to={`/details/${movie._id}`}>
            <button className="px-2 py-2 bg-red-700 text-black my-2 hover:bg-black hover:border-red-700 hover:border hover:text-white rounded-none">
              See Details
            </button>
          </Link>
        </div>
