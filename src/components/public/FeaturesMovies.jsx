...
const FeaturesMovies = () => {
    ...
    return (
        <div >
            ...
            <h1 className="  font-bold text-4xl text-center my-16"> Our Featured Movies  </h1>
...
//                 const response = await fetch("https://movie-portal-server-sigma.vercel.app/movie/top");
//                 const data = await response.json();
//                 console.log("Fetched Movies:", data); // Log the data to check its structure
//                 setMovies(data); // Set the state with the fetched movies
//             } catch (error) {
//                 console.error("Failed to fetch movies", error);
//             }
...
//                         movies.map(movie => (<Feature key={movie._id} movie={movie} />))
//                     ) : (
//                         <p>No featured movies available.</p> // Show a message if no data is found
//                     )
//                 }
//             </div>
...
//             <div className="text-center my-16">
//                 <Link to='/movies'>
//                     <button type="submit" className="btn md:px-10 rounded-full border-red-700 bg-black text-white hover:bg-red-700 hover:text-black">
//                         See All Movies
//                     </button>
//                 </Link>
//             </div>
