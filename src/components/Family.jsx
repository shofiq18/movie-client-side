        ...
        <div className="px-3 md:px-5 lg:px-0 py-12 ">
            <div className="max-w-7xl mx-auto p-3 md:p-0 md:flex justify-between items-center  md:gap-4 lg:gap-6">
                <div className="space-y-3">
                    ...
                    <h3 className=" text-2xl md:text-3xl lg:text-4xl font-extrabold text-black ">Live Movie & TV Shows <br /> For Friends & Family</h3>
                    ...
                    <div className="flex items-center gap-8 ">
                        ...
                        <div>
                            <span className="text-l md:text-2xl lg:text-3xl text-black font-extrabold">20K+</span>
